...
class RegimePrescrit
{
    ...
    private string $typeRegime = self::TYPE_NORMAL;
    ...
    private int $caloriesJournalieres = 0;
    ...
    private ?array $alimentsRecommandes = null;

    #[ORM\Column(type: Types::JSON, nullable: true)]
    private ?array $alimentsInterdits = null;
    ...
    private int $hydratationQuotidienne = 0;
    ...
    public function __construct()
    {
        ...
        $this->dateFin = new \DateTime('+30 days');
    }
    ...
    protected function setDatePrescription(\DateTimeInterface $datePrescription): static
    {
