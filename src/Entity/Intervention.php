...
#[ORM\Index(columns: ['statut_actuel'], name: 'idx_intervention_statut')]
#[ORM\Index(columns: ['employe_id'], name: 'idx_intervention_employe')]
#[ORM\Index(columns: ['payment_status'], name: 'idx_intervention_payment')]
class Intervention
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\JoinColumn(name: "service_request_id", referencedColumnName: "id", nullable: false, onDelete: "CASCADE")]
    ...
    public function setTarifHoraire(?string $v): self
    {
        $this->tarifHoraire = $v;
        return $this;
    }
