...
class Participation
{
    ...
    public function getActivityId(): ?int { return $this->activity?->getId(); }
    ...
    public function setActivityId(?int $activityId): self { /* backward compat - use setActivity() instead */ return $this; }
