...
#[ORM\Index(columns: ['statut'], name: 'idx_service_request_statut')]
#[ORM\Index(columns: ['created_at'], name: 'idx_service_request_created_at')]
#[ORM\Index(columns: ['technicien_id'], name: 'idx_service_request_technicien')]
#[ORM\Index(columns: ['type_service'], name: 'idx_service_request_type_service')]
class ServiceRequest
{
    ...
    private ?string $budgetMinimum = null;
    ...
    private ?string $budgetMaximum = null;
    ...
    #[ORM\OneToMany(mappedBy: "serviceRequest", targetEntity: Intervention::class, cascade: ["persist", "remove"], orphanRemoval: true)]
    ...
    public function getBudgetMinimum(): ?string
    {
        return $this->budgetMinimum;
    }
    public function setBudgetMinimum(?string $v): self
    {
        $this->budgetMinimum = $v;
        return $this;
    }

    public function getBudgetMaximum(): ?string
    {
        return $this->budgetMaximum;
    }
    public function setBudgetMaximum(?string $v): self
    {
