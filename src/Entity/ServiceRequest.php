...
class ServiceRequest
{
    ...
    private ?string $imageProblem = null;
    ...
    public function getImageProblem(): ?string
    {
        return $this->imageProblem;
    }

    public function setImageProblem(?string $imageProblem): self
    {
        $this->imageProblem = $imageProblem;
        return $this;
    }
    ...
    public function setAiAssisted(bool $aiAssisted): self
    {
